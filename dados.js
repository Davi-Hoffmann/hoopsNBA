let dados = [
    {
        ...
        tags: " Lakers, Los Angeles, LeBronJames, KobeBryant, NBAFinals, Showtime, times, time"
    },
    {
        ...
        tags: "Warriors, GoldenState, BayArea, StephenCurry, KlayThompson, DraymondGreen, ThreePointers, Championship, DubNation, times, time"
    },
    {
        ...
        tags: " Celtics, Boston, HardenFloors, LarryBird, BillRussell, NBAHistory, Rivalry, CelticPride, times, time"
    },
    {
        ...
        tags: "Bulls, Chicago, MichaelJordan, ScottiePippen, 90sBasketball, TheLastDance, SixRings, times, time"
    },
    {
        ...
        tags: "Heat, Miami, SouthBeach, LeBronJames, DwyaneWade, ChrisBosh, HeatNation, times, time"
    },
    {
        ...
        tags: "Spurs, SanAntonio, GreggPopovich, TimDuncan, ManuGinobili, TonyParker, FundamentalBasketball, times, time"
    },
    {
        ...
        tags: "76ers, Philadelphia, Process, JoelEmbiid, JamesHarden, AllenIverson, TrustTheProcess, times, time"
    },
    {
        ...
        tags: "Nets, Brooklyn, KevinDurant, KyrieIrving, NewYork, BigThree, times, time"
    },
    {
        ...
        tags: "Suns, Phoenix, ValleyOfTheSun, SteveNash, AmarStoudemire, DevinBooker, SevenSecondsOrLess, times, time"
    },
    {
        ...
        tags: "Mavericks, Dallas, DirkNowitzki, MavsNation, Championship, Texas, times, time"
    },
    {
        ...
        tags: "Hawks, Atlanta, TraeYoung, DominiqueWilkins, NBAPlayoffs, times, time"
    },
    {
        ...
        tags: "Hornets, Charlotte, LaMeloBall, KembaWalker, BuzzCity, times, time"
    },
    {
        ...
        tags: "Cavaliers, Cleveland, LeBronJames, KyrieIrving, NBAChampionship, TheLand, times, time, cavs"
    },
    {
        ...
        tags: "Nuggets, Denver, NikolaJokic, MileHighCity, JamalMurray, times, time"
    },
    {
        ...
        tags: "Pistons, Detroit, BadBoys, IsiahThomas, BenWallace, MotorCity, times, time"
    },
    {
        ...
        tags: "Rockets, Houston, JamesHarden, HakeemOlajuwon, YaoMing, ClutchCity, times, time"
    },
    {
        ...
        tags: "Pacers, Indiana, ReggieMiller, MaliceAtThePalace, HoosierState, times, time"
    },
    {
        ...
        tags: "Clippers, LosAngeles, KawhiLeonard, PaulGeorge, LobCity, times, time"
    },
    {
        ...
        tags: "Grizzlies, Memphis, JaMorant, GritAndGrind, ZachRandolph, times, time"
    },
    {
        ...
        tags: "Bucks, Milwaukee, GiannisAntetokounmpo, KhrisMiddleton, FearTheDeer, times, time"
    },
    {
        ...
        tags: "Timberwolves, Minnesota, KarlAnthonyTowns, AnthonyEdwards, KevinGarnett, times, time"
    },
    {
        ...
        tags: "Pelicans, NewOrleans, ZionWilliamson, BrandonIngram, SmoothieKingCenter, times, time"
    },
    {
        ...
        tags: "Knicks, NewYork, MadisonSquareGarden, CarmeloAnthony, JuliusRandle, times, time"
    },
    {
        ...
        tags: "Thunder, OklahomaCity, ShaiGilgeousAlexander, KevinDurant, RussellWestbrook, times, time"
    },
    {
        ...
        tags: "Magic, Orlando, ShaquilleONeal, DwightHoward, PennyHardaway, Disney, times, time"
    },
    {
        ...
        tags: "Blazers, Portland, DamianLillard, ClydeDrexler, RipCity, times, time"
    },
    {
        ...
        tags: "Kings, Sacramento, DeAaronFox, ChrisWebber, LightTheBeam, times, time"
    },
    {
        img: "assets/Toronto_Raptors_logo.png",
        alt: "",
        titulo: "Toronto Raptors",
        descricao: "Os Toronto Raptors se tornaram campeões da NBA em 2019, com uma campanha histórica. A equipe canadense busca continuar competindo em alto nível e conquistar mais títulos.",
        link: "https://pt.wikipedia.org/wiki/Toronto_Raptors",
        tags: "Raptors, Toronto, KawhiLeonard, KyleLowry, WeTheNorth, times, time"
    },
    {
        ...
        tags: "Jazz, Utah, KarlMalone, JohnStockton, DonovanMitchell, SaltLakeCity, times, time"
    },
    {
        ...
        tags: "Wizards, Washington, BradleyBeal, JohnWall, CapitalCity, times, time"
    }
];